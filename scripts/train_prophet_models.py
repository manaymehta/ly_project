...
os.makedirs("ml/models/prophet_models", exist_ok=True)
...
print(f"Saving to: ml/models/prophet_models/")
...
for _, pair in pairs.iterrows():
    ...
    try:
        ...
        model_path = f"ml/models/prophet_models/{hosp_id}_{drug_id}.pkl"
...
print(f"  Models saved in: ml/models/prophet_models/")
...
print("  1. Load ml/models/prophet_models/{hosp_id}_{drug_id}.pkl")
